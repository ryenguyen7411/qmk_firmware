...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [FN1] = LAYOUT(
    ...
    _______, KC_WH_R, KC_WH_U, KC_WH_D, KC_WH_L, _______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, C(KC_F3),
    _______, _______, _______, KC_BTN1, KC_BTN2, _______, _______, _______, C(KC_LEFT), C(KC_RIGHT), C(KC_UP),
    _______, _______, _______, _______, _______, _______, _______, _______, _______
  ),
  [FN2] = LAYOUT(
    KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12,
    _______, DF(MACROGAME), _______, _______, KC_BRID, KC_BRIU, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______,
  ...
  [MACROGAME] = LAYOUT(
    KC_ESC, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MUTE,
    MO(FN1), DF(BASE), _______, _______, _______, _______, _______, _______, MC_G_01, _______, _______,
